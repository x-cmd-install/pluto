...
[![x-cmd/install — pluto Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/pluto.svg?lang=zh)](https://x-cmd.com/install/pluto)
...
合计: **23,296** 行代码（覆盖前 5 种语言、共 **61** 个文件）。
...
- **Star**: 2,582 · **Fork**: 141 · **开放 issue**: 191 · **贡献者**: 47

## 累计统计

- **发布数**: 133 · **已合并 PR**: 285 · **开放 PR**: 7 · **已关闭 issue**: 185 · **开放 issue**: 6 · **提交数**: 352

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 1 | 2 | 3 | 0 | 1 | 8 |
| last60d | 2026-07-28 | 2 | 4 | 6 | 1 | 2 | 13 |
| 90d | 2026-06-28 | 3 | 5 | 7 | 2 | 2 | 14 |
| last180d | 2026-03-30 | 4 | 8 | 7 | 4 | 2 | 22 |
| 360d | 2025-10-01 | 9 | 18 | 7 | 4 | 2 | 32 |
| last720d | 2024-10-06 | 23 | 33 | 7 | 16 | 2 | 49 |
...
pluto 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `pluto` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pluto.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T06:13:35Z._
